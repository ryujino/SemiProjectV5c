...
import jinoru.spring.mvc.dao.MemberDAO;
...
//        return sb.toString();
        ...
        // 사람이 읽기 쉽고, 기계가 분석하기도 쉬어
        // 데이터 교환에 오래동안 사용했던 XML을 대체하고 있다.
        ...
        // ObjectMapper라이브러리를 이용하면
        // 손쉽게 JSON 유형의 데이터를 생성할 수 있다.
        ObjectMapper mapper = new ObjectMapper();
        String json = "";

        try {
            json = mapper.writeValueAsString(
                    mdao.selectZicode(dong)
