            ...
            <table class="table" style="border-top: 3px solid black;
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span style="float: right"><a href="javascript:addReply('${c.rno}')">[추가]</a> [수정] [삭제]</span>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="cmtfrm" id="cmtfrm" method="post" class="well form-inline">
                    ...
                    <div class="modal-footer">
                            <button type="button" id="cmtbtn" class="btn btn-danger">대댓글 장석</button>
                    </div>
                </div>
            </div>
        </div>
