    ...
    <div id="main">
        ...
        <div class="row margin1050">
            <table class="table">
                ...
                <tr><td class="text-left">첨부1</td><td>${p.fname}.${p.ftype} (${p.fsize}, ${p.fdown}회 다운로드함)</td></tr>
                <tr><td class="text-left">첨부2</td><td>${p.fname}.${p.ftype} (${p.fsize}, ${p.fdown}회 다운로드함)</td></tr>
            </table>
        </div><!-- 본문 -->
